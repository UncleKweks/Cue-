...
deploy-sepolia:
	@forge script script/DeployRatingsandReviews.s.sol:DeployRatingsandReviews --rpc-url $(SEPOLIA_RPC_URL) --account $(ACCOUNT) --sender $(SENDER) --etherscan-api-key $(ETHERSCAN_API_KEY) --broadcast --verify
